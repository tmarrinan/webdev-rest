<template>
    <section class="grid-container">
        <div class="title grid-x grid-margin-x">
            <div class="cell Crimetitle">
                <h6>Crime in Minnesota's capital, understood.</h6>
                <h3>St. Paul Crime Data</h3>
                <h3>Explorer</h3>
            </div>
